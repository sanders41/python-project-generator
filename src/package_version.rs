...
pub fn default_version(package: &PythonPackage) -> String {
    match package {
        ...
        PythonPackage::MkdocsMaterial => "9.6.8".to_string(),
        PythonPackage::Mkdocstrings => "0.28.3".to_string(),
        ...
        PythonPackage::Ruff => "0.9.10".to_string(),
...
pub fn default_pre_commit_rev(hook: &PreCommitHook) -> String {
    match hook {
        ...
        PreCommitHook::Ruff => "v0.9.10".to_string(),
    }
}
