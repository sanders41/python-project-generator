...
pub fn default_version(package: &PythonPackage) -> String {
    match package {
        PythonPackage::Maturin => "1.9.1".to_string(),
        PythonPackage::Mkdocs => "1.6.1".to_string(),
        PythonPackage::MkdocsMaterial => "9.6.15".to_string(),
        PythonPackage::Mkdocstrings => "0.29.1".to_string(),
        PythonPackage::MyPy => "1.17.0".to_string(),
        ...
        PythonPackage::Ruff => "0.12.4".to_string(),
...
pub fn default_pre_commit_rev(hook: &PreCommitHook) -> String {
    match hook {
        PreCommitHook::MyPy => "v1.17.0".to_string(),
        PreCommitHook::PreCommit => "v5.0.0".to_string(),
        PreCommitHook::Ruff => "v0.12.4".to_string(),
    }
}
