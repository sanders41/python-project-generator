...
pub fn default_version(package: &PythonPackage) -> String {
    match package {
        ...
        PythonPackage::MkdocsMaterial => "9.6.13".to_string(),
        ...
        PythonPackage::PytestCov => "6.1.1".to_string(),
        PythonPackage::Ruff => "0.11.9".to_string(),
...
pub fn default_pre_commit_rev(hook: &PreCommitHook) -> String {
    match hook {
        ...
        PreCommitHook::Ruff => "v0.11.9".to_string(),
    }
}
